...
Stock-AI is a web dashboard designed to provide optimal investment information for the Korean stock market (KOSPI, KOSDAQ) by combining Short-term Prediction (LightGBM) and Long-term Prediction (LSTM) models. It features an automated pipeline utilizing GitHub Actions and a mock investment function powered by Supabase.
📝 Project Overview
...
Collection of stock price, supply/demand, and macro data
Automation
GitHub Actions
Nightly automated data crawling & preprocessing (Cron)
Model Serving
LightGBM, PyTorch (LSTM)
Model training and inference
Database
Supabase (PostgreSQL)
Storage for mock investment user data
Frontend
HTML/CSS
Web dashboard and visualization (Mobile Responsive)
...
⚠️ Disclaimer
The information provided by this service is based on AI analysis of historical data. All investment decisions are the sole responsibility of the user.
This service does not constitute investment advice or recommendation.
👨‍💻 Author
